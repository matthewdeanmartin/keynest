...
1. **GitHub private vulnerability reporting** —
   [submit a confidential report](https://github.com/matthewdeanmartin/keynest/security/advisories/new)
...
For maximum isolation, run `keynest` inside a container so it only has access to what you
explicitly mount.
